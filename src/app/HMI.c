...
void Display_RunTimeH(void)
{
	...
	if(RD_FinishFlag)
	{
		Motor_Parameter.RT_runtimeH = (DataBufH << 8) + DataBufL;
...
{
	disp_24x24(1,6,Hanzi_2424_HWZS_Zhi);
	disp_24x24(25,6,Hanzi_2424_HWZS_Dian);
...
void Disp_Usr_PWD_Input(void)
{
	clear_screen();
	Display_Full_Line(1, Up);
	Display_Full_Line(3, Up);
	Display_InputCodeText();
	...
	CHAR_Display_16x8(65, 5,char_star, 0);
	CHAR_Display_16x8(81, 5,char_star, 0);
	CHAR_Display_16x8(97, 5,char_star, 0);
	CHAR_Display_16x8(113, 5,char_star, 0);
	
}
void Disp_Usr_Pg(uchar Func, uchar F_Para)
{
	;
}

void Disp_PWD_Nbr(void)
{
	;
}
...
{
	Hanzi_Disp_16x16(49, 1, Hanzi_1616_XST_Qing, 1);
	Hanzi_Disp_16x16(65, 1, Hanzi_1616_XST_Shu1, 1);
	Hanzi_Disp_16x16(81, 1, Hanzi_1616_XST_Ru, 1);
	Hanzi_Disp_16x16(97, 1, Hanzi_1616_XST_Yong, 1);
	Hanzi_Disp_16x16(113, 1, Hanzi_1616_XST_Hu, 1);
	Hanzi_Disp_16x16(129, 1, Hanzi_1616_XST_Mi, 1);
	Hanzi_Disp_16x16(145, 1, Hanzi_1616_XST_Ma, 1);
...
0x00,0x02,0x0C,0x88,0x69,0x09,0x09,0x89,0x69,0x09,0x09,0x19,0x28,0xC8,0x0A,0x0C,
0x00,0x20,0x20,0x20,0x20,0x20,0x22,0x21,0x7E,0x60,0xA0,0x20,0x20,0x20,0x20,0x20};/*"学",0*/

uchar code Hanzi_1616_XST_Xi[]={
0x00,0x00,0x40,0x40,0x40,0x48,0x44,0x43,0x40,0x40,0x40,0x40,0x40,0x7F,0x00,0x00,
0x00,0x00,0x10,0x18,0x10,0x20,0x20,0x20,0x40,0x40,0x82,0x81,0x02,0xFC,0x00,0x00};/*"习",0*/

uchar code Hanzi_1616_XST_Zi[]={
0x00,0x00,0x00,0x1F,0x11,0x31,0x51,0x91,0x11,0x11,0x11,0x1F,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0xFF,0x22,0x22,0x22,0x22,0x22,0x22,0x22,0xFF,0x00,0x00,0x00,0x00};/*"自",0*/

uchar code Hanzi_1616_XST_Dong[]={
0x02,0x22,0x23,0x22,0x22,0x22,0x02,0x08,0x08,0xFF,0x08,0x08,0x08,0x0F,0x00,0x00,
0x08,0x3C,0xC8,0x08,0x28,0x1D,0x02,0x0C,0x70,0x80,0x02,0x01,0x02,0xFC,0x00,0x00};/*"动",0*/

uchar code Hanzi_1616_XST_Kai[]={
0x01,0x41,0x41,0x41,0x7F,0x41,0x41,0x41,0x41,0x41,0x7F,0x41,0x41,0x41,0x01,0x00,
0x00,0x01,0x02,0x0C,0xF0,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00};/*"开",0*/

uchar code Hanzi_1616_XST_Guan[]={
0x00,0x00,0x08,0x88,0x68,0x08,0x08,0x0F,0x08,0x08,0x28,0xC8,0x08,0x00,0x00,0x00,
0x81,0x81,0x82,0x82,0x84,0x88,0xB0,0xC0,0xB0,0x88,0x84,0x82,0x82,0x81,0x81,0x00};/*"关",0*/

uchar code Hanzi_1616_XST_Dian1[]={
0x00,0x00,0x03,0x02,0x02,0x02,0xFE,0x12,0x12,0x12,0x12,0x13,0x10,0x10,0x00,0x00,
0x01,0x02,0xEC,0x20,0x20,0x28,0x26,0x20,0x28,0x26,0x20,0xE0,0x08,0x07,0x00,0x00};/*"点",0*/

uchar code Hanzi_1616_XST_Ting[]={
0x01,0x06,0x1F,0xE0,0x00,0x20,0x2E,0x2A,0xAA,0x6A,0x2A,0x2A,0x2E,0x20,0x00,0x00,
0x00,0x00,0xFF,0x00,0xC0,0x80,0xA0,0xA2,0xA1,0xBE,0xA0,0xA0,0xA0,0x80,0xC0,0x00};/*"停",0*/

uchar code Hanzi_1616_XST_Zhi[]={
0x00,0x00,0x00,0x0F,0x00,0x00,0x00,0xFF,0x02,0x02,0x02,0x02,0x02,0x00,0x00,0x00,
0x02,0x02,0x02,0xFE,0x02,0x02,0x02,0xFE,0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x00};/*"止",0*/

uchar code Hanzi_1616_XST_Men[]={
0x00,0x1F,0x80,0x60,0x00,0x00,0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x7F,0x00,0x00,
0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x02,0x01,0xFE,0x00,0x00};/*"门",0*/

uchar code Hanzi_1616_XST_Qing[]={
...
uchar code Hanzi_1616_XST_Shu1[]={
0x11,0x16,0xF8,0x13,0x10,0x08,0x13,0x2A,0x4A,0x8B,0x48,0x29,0x10,0x0B,0x08,0x00,
0x90,0x98,0x90,0xFF,0xA0,0x00,0xFF,0x48,0x49,0xFF,0x00,0xFA,0x01,0xFE,0x00,0x00};/*"输",0*/

uchar code Hanzi_1616_XST_Ru[]={
0x00,0x00,0x00,0x00,0x00,0x80,0x47,0x38,0x07,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x01,0x02,0x04,0x08,0x30,0xC0,0x00,0x00,0x00,0xC0,0x30,0x0C,0x02,0x01,0x01,0x00};/*"入",0*/

uchar code Hanzi_1616_XST_Yong[]={
0x00,0x00,0x7F,0x44,0x44,0x44,0x44,0x7F,0x44,0x44,0x44,0x44,0x7F,0x00,0x00,0x00,
0x01,0x06,0xF8,0x40,0x40,0x40,0x40,0xFE,0x40,0x40,0x42,0x41,0xFE,0x00,0x00,0x00};/*"用",0*/

uchar code Hanzi_1616_XST_Hu[]={
0x00,0x00,0x00,0x1F,0x10,0x10,0x90,0x70,0x10,0x10,0x10,0x10,0x1F,0x00,0x00,0x00,
0x00,0x01,0x06,0xF8,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0x80,0xC0,0x00,0x00,0x00};/*"户",1*/

uchar code Hanzi_1616_XST_Mi[]={
0x08,0x31,0x22,0x20,0x27,0x20,0xA9,0x65,0x22,0x24,0x28,0x21,0x22,0x29,0x30,0x00,
0x40,0x40,0x5E,0x82,0x82,0xC2,0x42,0x7E,0x42,0x42,0x42,0xC2,0x1F,0x00,0x00,0x00};/*"密",2*/
...
uchar code char_star[]={
0x09,0x0D,0x07,0x03,0x03,0x07,0x0D,0x09,0x20,0x60,0xC0,0x80,0x80,0xC0,0x60,0x20};/*"*",0*/
...
0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x0C,0x07,0x07,0x00,0x00,0x01,0x06,0x1C,0x18,0x00,0x03,
0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x88,0x88,0x88,0x88,0x88,0x88,0x8B,0xFF,0xFC,
0x8E,0x89,0x88,0x88,0x88,0x88,0x98,0xB8,0x98,0x08,0x00,0x00,0x00,0x00,0x04,0x04,0x08,0x08,
0x10,0x30,0x60,0xC0,0x80,0x00,0x00,0x80,0xC0,0x70,0x30,0x18,0x1C,0x18,0x08,0x08,0x00,0x00};/*"关",0*/
...
0x00,0x04,0x04,0x04,0x04,0x05,0x0F,0x0E,0x04,0x00,0x02,0x02,0x02,0x06,0x04,0x07,0x0F,0x0C,
0x18,0x08,0x08,0x00,0x00,0x00,0x00,0x00,0x14,0x3B,0xF0,0xD0,0x11,0x3F,0x3C,0x10,0x00,0xFF,
0x7F,0x40,0x00,0xFF,0xFF,0x20,0x20,0x60,0x63,0x21,0x00,0x00,0x00,0x00,0x04,0x08,0x90,0x60,
0xE0,0xB0,0x18,0x18,0x18,0x98,0x98,0x88,0x88,0x8C,0x8C,0x8C,0x8C,0x8C,0x8C,0x98,0x90,0x10};/*"延",0*/

uchar code Hanzi_2424_HWZS_Shi[]={
0x00,0x00,0x00,0x07,0x03,0x02,0x02,0x02,0x07,0x07,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
